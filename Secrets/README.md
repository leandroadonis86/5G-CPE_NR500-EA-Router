...
The following example show how the request is made by router's webpage. When the user submit a form, one Ajax Request is created to `/goform/formJsonAjaxReq` through `jbc/abc.js` javascript. 
